...
public class ModJetpacks {
    ...
    private static final Jetpack STONE = JetpackRegistry.createJetpack("stone", 1, 0x7F7F7F, 2, 12, "minecraft:stone");
    private static final Jetpack IRON = JetpackRegistry.createJetpack("iron", 2, 0xC1C1C1, 3, 9, "minecraft:iron_ingot");
    ...
    static {
        //                  capacity   usage  spdV   acclV  spdS   spdHA  spdHD   spdHS  sprint spdVSp spFuel
        WOOD.setStats(     20000,      32,    0.18D, 0.10D, 0.06D, 0.16D, 0.25D, 0.14D, 1.0D,  1.0D,  1.0D);
        STONE.setStats(    100000,     70,    0.25D, 0.11D, 0.08D, 0.18D, 0.25D, 0.10D, 1.0D,  1.0D,  1.0D);
        ...
        NETHERITE.setStats(64000000,   1000,  1.12D, 0.23D, 0.23D, 0.48D, 0.25D, 0.0D,  2.2D,  1.6D,  4.2D);
        CREATIVE.setStats( 0,          0,     1.03D, 0.17D, 0.21D, 0.45D, 0.25D, 0.0D,  2.0D,  1.5D,  0.0D);

        COPPER.setStats(   250000,     85,    0.29D, 0.11D, 0.10D, 0.23D, 0.25D, 0.092D,1.05D, 1.025D,1.4D);
        BRONZE.setStats(   800000,     120,   0.41D, 0.12D, 0.14D, 0.27D, 0.25D, 0.075D,1.1D,  1.05D, 2.1D);
        SILVER.setStats(   1200000,    150,   0.48D, 0.13D, 0.15D, 0.30D, 0.25D, 0.07D, 1.3D,  1.15D, 2.7D);
